...
public class mainActivity extends AppCompatActivity {
    ...
    public void quickAdd(View view){
        ...
        if(!nrInput.equals("")){
            ...
            updateMainDisplayBoard(quickAddInt, false);
        }else{
     ...
     * TODO : Check that this is not run 2 times on onCreate()
     * Help method to update MainActivity's board display.
     */
    private void updateMainDisplayBoard(int newExpenditure, boolean updateAll){
